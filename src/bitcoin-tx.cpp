...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Ladybug Pupa ladybug-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ladybug-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ladybug transaction") + "\n" +
              "  ladybug-tx [options] -create [commands]   " + _("Create hex-encoded ladybug transaction") + "\n" +
              "\n";
