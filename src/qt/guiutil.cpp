...
{
    // return if URI is not valid or is no ladybug: URI
...
{
    // Convert ladybug:// to ladybug:
    //
    //    Cannot handle this later, because ladybug:// will cause Qt to see the part after // as host,
    //    which will lower-case it (and thus invalidate the address).
    if(uri.startsWith("ladybug://", Qt::CaseInsensitive))
    {
        uri.replace(0, 10, "ladybug:");
    }
...
{
    QString ret = QString("ladybug:%1").arg(info.address);
    int paramCount = 0;
